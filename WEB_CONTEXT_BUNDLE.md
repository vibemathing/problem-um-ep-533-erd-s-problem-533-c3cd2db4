...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-533-erd-s-problem-533-c3cd2db4-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-533"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-533-erd-s-problem-533-c3cd2db4-v1",
      "problem_contract_sha256": "a38d0ddb56e1a4ea313d8a27799c53a5230fb7b58b44fa175e8814cae319907c",
      "problem_id": "problem:um-ep-533-erd-s-problem-533-c3cd2db4",
      "route_id": "route:um-ep-533-erd-s-problem-533-c3cd2db4-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-533-erd-s-problem-533-c3cd2db4-source-fidelity-01",
      "graph_id": "graph:um-ep-533-erd-s-problem-533-c3cd2db4-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-533-erd-s-problem-533-c3cd2db4-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-533-erd-s-problem-533-c3cd2db4-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $\\delta>0$. If $n$ is sufficiently large and $G$ is a graph on $n$ vertices with no $K_5$ and at least $\\delta n^2$ edges then $G$ contains a set of $\\gg_\\delta n$ vertices containing no triangle."
          },
          "statement_sha256": "4498fac2dff09cc8e600160344360c7c67e29cb38230762b16fc655e74ec83d6"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-533-erd-s-problem-533-c3cd2db4-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-533-erd-s-problem-533-c3cd2db4-root",
      "route_id": "route:um-ep-533-erd-s-problem-533-c3cd2db4-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-533-b640c9ad2bcf",
        "url": "https://www.unsolvedmath.com/problems/EP-533"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
